...
RegisterNetEvent("f-warehousehiest:client:alertcops", function()
	...
	elseif Config.PDAlerts == "qb" then
		...
		TriggerServerEvent('police:server:policeAlert', 'Warehouse Breach') -- Regular qbcore
