...
local checkVersion = function(err, response, headers)
    ...
    local resourceName = "f-warehouseheist ("..GetCurrentResourceName()..")" -- the resource name
...
AddEventHandler('onResourceStart', function(resource)
   ...
   local path = "https://raw.githubusercontent.com/Friskky1/f-warehouseheist/main/fxmanifest.lua" -- your git user/repo path
